...
## uvicorn EAPDocsRESTChatBot:app --reload ##
####################################
...
@app.get("/chat/")
def rest_chat(q: Union[str, None] = None):
    response = chat_engine.chat(q)
    source_details = []
    for source_node in response.source_nodes:
        source_details.append("File: " + source_node.metadata['file_name'] + ", Page: " + source_node.metadata['page_label'])
    return {"response": response, "source_details": source_details}
